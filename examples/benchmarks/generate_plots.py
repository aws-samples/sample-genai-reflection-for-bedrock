...
plt.ylabel(metric, fontsize=22, weight="bold")
plt.ylim(0, 106)
plt.title(f"Performance in {title}", fontsize=21, weight="bold")
...
plt.savefig(f"{current_dir}/{benchmark_name}/result.png", dpi=300)
